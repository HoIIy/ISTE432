...
* __Project Manager__ - __*Holly (only if neither of you want to handle it, I'm not fussed)*__  - accounts for overall coordination of project, checking in with members, monitoring deadlines, and ensuring that work is steadily progressing.
