...
If we were going to implement a help system for this application, an ideal combination would be a help page with an overview of how to use it plus tooltips on individual components. Tooltips would be especially helpful for the form fields - we could use them as placeholders for more information about the options and what is and isn't valid input for them. 

If the application were more expansive, a help wiki or support forum would be excellent; this would probably be excessive for a single-page application.